...
# dictionaries within a list and each dictionary has three different keys: title, author, and description
# I know dictionaries are within a list because the entire data are surrounded by brackets so it's a list, but 
# the data inside are surrounded by curly braces so I know they are dictionaries with key value pairs inside them.
